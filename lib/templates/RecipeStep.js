        ...
        return (
          <SafeAreaView style={styles.recipeStepContainer}>
						...
						<View style={styles.stepContainer}>
							<RecipeStepsIndicator currStep={this.props.currStep} nSteps={this.props.totalSteps} />

							<View style={styles.stepContent}>
								<Text style={styles.stepText}>{ this.props.currInstruction }</Text>
						...
						<View style={styles.recipeNav}>
							<TouchableHighlight onPress={this.props.prevStep}><Icon name="Previous" width="26" height="26" fill="#EEEEEE" /></TouchableHighlight>
							<TouchableHighlight onPress={this.props.nextStep}><Icon name="Next" width="26" height="26" fill="#EEEEEE" /></TouchableHighlight>
